...
<head>
  ...
  <link href="<?php echo $root; ?>/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
	...
	<div class="col-lg-8 d-flex">
      ...
      <div class="logo me-auto">
        <!-- <h1><a href="<?php echo $root; ?>/">Lumia</a></h1> -->
        <!-- Uncomment below if you prefer to use an image logo -->
        <a href="index.html"><img src="<?php echo $root; ?>/media/bens-gram_logo.png" alt="" class="img-fluid" style="max-width: 103px;"></a>
      </div>
